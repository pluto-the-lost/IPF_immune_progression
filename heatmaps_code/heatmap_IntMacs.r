...
write.table(top5,'IntMacs.marker.xls',sep='\t',quote=F,col.names=T,row.names=F)
mat<-rds@assays$RNA@data
gene<-c('Ifi27l2a','AC160336.1','Ccrl2','Ptger4','Tgm3','H2-Aa','Clec4e','Phlda1','Ccl2','Ccl3','Hmox1','Hspa1b','Thb1','Cdk2ap1','Tsc22d3','Saa3','Chil3','Apoe','Wfdc17','Igkc')
write.table(top5,'IM_gene.xls',sep='\t',col.names=T,row.names=T,quote=F)
...
pdf('IntMacs_heatmap.pdf',h=10,w=10)
